...
int buzzerPin = 12;                          //Pin number the buzzer is connected
...
int minBeebInterval = 1300;             //Min beep interval
...
int triggerAlarmDistance = 15;              //Buzzer will be triggered if the distance is less than this value. (cm)
...

{
...

  {
    ...
    Serial.println( "maximum level of the garbage reached!!");
...

{
  ...
  GPRS.write("+918870341015");           // the number to send the SMS to
  ...
  GPRS.print("ID:=1 LOCATION:=maximum level reached"); // Send the text message to the GSM module
